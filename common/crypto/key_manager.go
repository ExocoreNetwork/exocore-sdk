...
func NewPriKeyManager(pri []byte, algo string) (KeyManager, error) {
	k := keyManager{
		mnemonic: "",
		algo:     algo,
	}
	err := k.recoveryFromPri(pri, algo)
	return &k, err
}
...
func (m *keyManager) recoveryFromPri(derivedPriv []byte, algoStr string) error {
