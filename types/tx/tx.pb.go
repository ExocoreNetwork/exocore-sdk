...
import (
	...
	types1 "github.com/ExocoreNetwork/exocore-sdk/common/crypto/types"
	...
	signing "github.com/ExocoreNetwork/exocore-sdk/types/tx/signing"
	io "io"
	math "math"
	math_bits "math/bits"
)
...
type Fee struct {
	...
	Amount github_com_exocore_core_sdk_go_types.Coins `protobuf:"bytes,1,rep,name=amount,proto3,castrepeated=github.com/ExocoreNetwork/exocore-sdk/types.Coins" json:"amount"`
...
func (m *Fee) GetAmount() github_com_exocore_core_sdk_go_types.Coins {
	if m != nil {
		return m.Amount
	}
	return nil
