...
import "./interfaces/exocore/IServiceManager.sol";
import "./interfaces/exocore/ITaskManager.sol";
...
abstract contract TaskManager is
    Initializable,
    OwnableUpgradeable,
    Pausable,
    BLSSignatureChecker,
    ...
    ITaskManager
{
    ...
    function raiseAndResolveChallenge(
        ...
        //         address operatorAddress = BLSApkRegistry(
        //             address(blsApkRegistry)
        //         ).pubkeyHashToOperator(operatorID);
