...
contract OperatorStateRetriever {
    ...
    function getCheckSignaturesIndices(
        ...
        checkSignaturesIndices
            .nonSignerQuorumBitmapIndices = registryCoordinator
        ...
        checkSignaturesIndices.nonSignerStakeIndices = new uint32[][](
        ...
        for (
            ...
            for (uint i = 0; i < numNonSignersForQuorum; i++) {
                nonSignerStakeIndicesForQuorum[i] = checkSignaturesIndices
                    .nonSignerStakeIndices[quorumNumberIndex][i];
            }
            checkSignaturesIndices.nonSignerStakeIndices[
                quorumNumberIndex
        ...
        checkSignaturesIndices.quorumApkIndices = blsApkRegistry
            .getApkIndicesAtBlockNumber(quorumNumbers, referenceBlockNumber);
