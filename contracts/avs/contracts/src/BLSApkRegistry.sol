    ...
    *******************************************************************************/
    ...
    function _processQuorumApkUpdate(
        ...
        for (uint256 i = 0; i < quorumNumbers.length; i++) {
            ...
            ApkUpdate storage lastUpdate = apkHistory[quorumNumber][
                historyLength - 1
            ];
    ...
    *******************************************************************************/
    ...
    function getApkIndicesAtBlockNumber(
        ...
        for (uint i = 0; i < quorumNumbers.length; i++) {
            uint8 quorumNumber = uint8(quorumNumbers[i]);
            uint32 quorumApkUpdatesLength = uint32(
                apkHistory[quorumNumber].length
            );
            ...
            for (uint32 j = 0; j < quorumApkUpdatesLength; j++) {
                if (
                    apkHistory[quorumNumber][quorumApkUpdatesLength - j - 1]
