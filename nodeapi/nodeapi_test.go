...
func TestSpecVersionHandler(t *testing.T) {
	req := httptest.NewRequest(http.MethodGet, "/exo/node/spec-version", nil)
...
func TestNodeHandler(t *testing.T) {
	req := httptest.NewRequest(http.MethodGet, "/exo/node", nil)
	w := httptest.NewRecorder()
...
func TestHealthHandler(t *testing.T) {
	...
	for name, test := range tests {
		t.Run(name, func(t *testing.T) {
			req := httptest.NewRequest(http.MethodGet, "/exo/node/health", nil)
			w := httptest.NewRecorder()
...
func TestServicesHandler(t *testing.T) {
	...
	for name, test := range tests {
		t.Run(name, func(t *testing.T) {
			req := httptest.NewRequest(http.MethodGet, "/exo/node/services", nil)
			w := httptest.NewRecorder()
...
func TestServiceHealthHandler(t *testing.T) {
	req := httptest.NewRequest(http.MethodGet, "/exo/node/services/123/health", nil)
	w := httptest.NewRecorder()
