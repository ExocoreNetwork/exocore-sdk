...
type MsgSend struct {
	...
	Amount      github_com_exocore_core_sdk_go_types.Coins `protobuf:"bytes,3,rep,name=amount,proto3,castrepeated=github.com/ExocoreNetwork/exocore-sdk/types.Coins" json:"amount"`
}
