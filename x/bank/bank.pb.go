...
type Input struct {
	...
	Coins   github_com_exocore_core_sdk_go_types.Coins `protobuf:"bytes,2,rep,name=coins,proto3,castrepeated=github.com/ExocoreNetwork/exocore-sdk/types.Coins" json:"coins"`
}
...
type Supply struct {
	Total github_com_exocore_core_sdk_go_types.Coins `protobuf:"bytes,1,rep,name=total,proto3,castrepeated=github.com/ExocoreNetwork/exocore-sdk/types.Coins" json:"total"`
}
