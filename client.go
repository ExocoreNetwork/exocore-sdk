...
import (
	"github.com/ExocoreNetwork/exocore-sdk/client"
	keys "github.com/ExocoreNetwork/exocore-sdk/client"
	commoncodec "github.com/ExocoreNetwork/exocore-sdk/common/codec"
	cryptotypes "github.com/ExocoreNetwork/exocore-sdk/common/codec/types"
	commoncryptocodec "github.com/ExocoreNetwork/exocore-sdk/common/crypto/codec"
	"github.com/ExocoreNetwork/exocore-sdk/types"
	txtypes "github.com/ExocoreNetwork/exocore-sdk/types/tx"
	bank2 "github.com/ExocoreNetwork/exocore-sdk/x/bank"
	staking2 "github.com/ExocoreNetwork/exocore-sdk/x/staking"
...
func NewClient(cfg types.ClientConfig) Client {
	...
	stakingClient := staking2.NewClient(baseClient, encodingConfig.Marshaler)
